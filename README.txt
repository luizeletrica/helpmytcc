Ultima Atualização 26/10

/////////////versão "agora foi! 5" Atualizada com Novo erro
thikspeak4(small)
/////////////

O arquivo "thikspeak4(small)" é um programa da -Tomada monitorada wifi V5- ultilizando um NODEMCU ESP32. Versão atualizada da ultima versão testada "agorafoi!5"
...
Como ainda está em FASE DE TESTES, nesta versão foi fixado um valor de 78U para envio do thingspeak.
...
**1 - Nesta versão 5, o gráfico do ThinkSpeak não funciona, (hipotese: não está recebendo ou enviando os dados). 
	//CORRIGIDO HIPOTESE CONFIRMADA, O ESP NÃO ENVIAVA OS DADOS PARA O thingspeak.

NOVOS ERROS
**I - O Esp32 não possui mais um ip fixo, quando a linha 117 esta descomentada, pode se vizualizar a IHM, porem o envio para thingspeak não funciona.

**II - Não é possivel vizualizar os valores da IHM, "Corrente, Tensao, Potencia, Consumo(Kw)" provavelmente estão demorando para serem mostrados

**III - O comando para ligar ou desligar a lampada pode demorar até  mais 1 minuto

obs. de maneira geral o sistema inteiro ficou mais lento. com excessão do thingspeak que mantem seu envio do iframe a cada 15seg aprox.
