//Programa : Tomada monitorada wifi V5 - NODEMCU ESP32

/*Descrição: Este projeto tem a finalidade do usuario de monitorar seu consumo 
de energia e poder acionar seu equipamento através da rede local wifi.
Como ainda está em FASE DE TESTES, está sendo ultilizado um sensor LDR.

**Nesta versão 5, o gráfico do ThinkSpeak não está recebendo os dados.
**Protocolo NTP tambem não funcionou, pois este seria ultilizado para criar um 
data logger de contagem de minutos/horas no dia em o sensor marcou acima de 0A
para a memória interna do Nodemcu. Assim poderia se calcular o valor previsto e atual de consumo.
**Nesta versão tambem há um problema com o JavaScript/CSS. Deveria mostrar uma lampada de identificação
quando o equipamento/lampada estiver ligado (acesa) e desligada(apagada). O codigo base tambem foi ultilizado
do FilipeFlop.
*/
//OBS. TODO O CODIGO FOI FEITO PARA O ESP32, SENDO ASSIM, ALGUNS COMENTEARIOS PODEM SER DESCONSIDERADOS, 
//POIS COMO  HÁ MUITAS ALTERAÇÕES, ESTES COMENTARIOS SERAM REALIZADOS NA VERSÃO FINAL.
...
////////////////////////////////////////////////////////////////////////////
//CODIGO THINKSPEAK BASEADO NO FILIPE FLOP
...
float FazCLeitura(void)
{
	...
	int Cleitura = analogRead(portaLDR);
         
     Serial.print("[CLeitura] ");
     Serial.print(Cleitura);
     Serial.println("A");
...
float last(void)
 {
	  ...
	  float CLeituraLida;
    int CLeituraTruncada;
    char FieldCLeitura[11];
     
    CLeituraLida = FazCLeitura();
    CLeituraTruncada = (int)CLeituraLida;
    
        sprintf(FieldCLeitura,"field1=%d",CLeituraTruncada);
        EnviaInformacoesThingspeak(FieldCLeitura);
    
 }
/////////////////////////////////////////////////

boolean ligado = true; //LAMPADA SCRIPT
...
void setup()
{
  ...
  lastConnectionTime = 0; // PARTE DO CODIGO FILIPE FLOP//////////////////////////////////////////////
   ...
   "function refreshleitura()"
    "{"
      ...
      "xmlhttp.onreadystatechange = function() {"
        ...
        "}"
      "};"
      "xmlhttp.open('GET', 'http://192.168.1.106/leitura', true);"
   ...
   "function refreshtensao()"
    "{"
      ...
      "xmlhttp.onreadystatechange = function() {"
        ...
        "}"
      "};"
      "xmlhttp.open('GET', 'http://192.168.1.106/tensao', true);"
   ...
   "function refreshpot()"
    "{"
      ...
      "xmlhttp.onreadystatechange = function() {"
        ...
        "}"
      "};"
      "xmlhttp.open('GET', 'http://192.168.1.106/pot', true);"
   ...
   "function refreshkwh()"
    "{"
      ...
      "xmlhttp.onreadystatechange = function() {"
        ...
        "}"
      "};"
      "xmlhttp.open('GET', 'http://192.168.1.106/kwh', true);"
